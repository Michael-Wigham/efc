...
class GPIO {
public:
    static std::shared_ptr<GPIO> getGPIO(uint32_t pin, gpio_pinmode_t pin_mode/* , gpio_intr_mode_t intr = INTR_DISABLE */);
    ...
    uint32_t getPin() __attribute__ ((__noinline__)) {
        return m_pin;
    }
...
private:
    GPIO(uint32_t pin, gpio_pinmode_t pin_mode/* , gpio_intr_mode_t intr = INTR_DISABLE */);
